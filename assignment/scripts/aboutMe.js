...
// console.log `mostPets` after the conditional has run.
    let mostPets = ' most pets!';
    if (pets > friendsPets)
    {console.log('I have the' + mostPets);
    }// end if I have more pets
    else if (pets === friendsPets)
    {console.log('We have the same amount of pets!');
    }
    else {console.log('My friend has the' + mostPets);
    }// my friend has the most pets
...
//      You'll need to research how to use switch statements!
    switch(luckyNumber) {
        ...
        case 10 : console.log('Remember Remember the 10th of October')
        break;
